...
powershell -Command "New-Item -path 'C:\Program Files\OpenSSH\bin' -name 'sudo' -Value '/bin/bash -c $*'  -ItemType File -force" <NUL

rmdir c:\mnt
rmdir c:\vagrant
mkdir c:\vagrant
mkdir "C:\Program Files\OpenSSH\opt" ; mkdir "C:\Program Files\OpenSSH\opt\vagrant"
